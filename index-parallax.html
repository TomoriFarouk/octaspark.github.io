...
<section id="colors-switcher">
    ...
    <div>
        ...
        <ul class="colors" id="color1">
            ...
            <li><a data-class="style12.css" href="index.html#" class="waves-effect waves-light style12"></a></li>
...
<nav id="main-nav" class="nav-down">
    ...
    <div class="nav-wrapper">
        ...
        <a class="brand-logo design-font waves-effect waves-light no-bg" data-scroll-nav="0" href="#">
            <img class="responsive-img logo" src="images/logo.svg" alt="">
            <p class="title-link">
...
<!-- Start About Section-->
<section id="about-us" class="main-section center-align" data-scroll-index="1">
...
<section id="features" data-scroll-index="3" class="main-section center-align">
        ...
        <div class="row p-t-2">
            ...
            <div class="col push-m3 push-s3 s6 m6 l4 p-tb-1 images-slider">
                ...
                <div class="owl-carousel owl-features">
                    ...
                    <div>
                        <img class="responsive-img" src="images/iphone-mock/blue/1-1.jpg" alt="image of the iPhone app">
                    </div>

                    <div>
                        <img class="responsive-img" src="images/iphone-mock/blue/1-4.jpeg" alt="image of the iPhone app">
                    </div>
...
3
                    ...
                    <div>
                        <img class="responsive-img" src="images/iphone-mock/blue/1-5.jpg" alt="image of the iPhone app">
                    </div>

                    <div>
                        <img class="responsive-img" src="images/iphone-mock/blue/1-3.jpg" alt="image of the iPhone app">
                    </div>
    ...
    <div class="container">
        ...
        <div class="owl-carousel owl-testimonials">
            ...
            <div>
                ...
                <!-- Client Image -->
                <div>
                    <img class="responsive-img circle" src="images/team/testimonials4.jpg" alt="Image of a John, one member of the team created the app">
                </div>
...
<section id="download" data-scroll-index="3" class="main-section" style="background: url('images/background/header-bg-10.jpg') center fixed;">
        ...
        <div class="row p-t-2">
            ...
            <div class="col s12 l9">
                ...
                <a href="#" class="m-t-1 grey darken-4 waves-effect waves-light">
                    ...
                    <span class="text">
                        <small>available on</small><br> Windows Store
                    </span>

                </a>

                <a class="waves-effect waves-light" href="images/iphone-mock/qrcode.jpg" data-lity>Scan QR Code</a>
            ...
            <div class="col s12 l3 hide-on-med-and-down"  data-aos="fade-left" data-aos-delay="100">
                ...
                <img class="responsive-img" src="images/iphone-mock/blue/1-1.png" alt="">
...
<section id="statistics" class="main-section center-align" style="background: url('images/background/header-bg-10.jpg') bottom fixed;">
        ...
        <div class="footer-content p-t-3 left-align">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!-- News -->
                    <div class="news col s12 m6 l3">

                        <h5 class="p-b-2">News</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col s6">
                                ...
                                <!-- Image -->
                                <a href="#">
                                    <img class="responsive-img waves-effect" src="images/news/news4.jpg" alt="news image">
                                </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col s6">
                                ...
                                <!-- Image -->
                                <a href="#">
                                    <img class="responsive-img waves-effect" src="images/news/news2.jpg" alt="news image">
                                </a>
...
<div id="copy-rights" class="col s12">
    ...
    <div class="container">
        ...
        <!-- Your Copy Right -->
        <p>Copyright &copy; 2017 Apperle HTML template by <a href="https://themeforest.net/user/perletheme">Perle</a></p>
